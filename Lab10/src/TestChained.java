...
public class TestChained {
	...
	@Test
	public void testAdd() {
		DictionaryInterface<String, Integer> d = new HashDictionaryChained<String, Integer>();
	...
	public void testStressfulAdd() {
		...
		// now a stress test
		d = new HashDictionaryChained<String, Integer>();
		...
		for (int i = 0; i < 50; i++) {
			...
			System.out.println(d.contains(Integer.toString(i)));
